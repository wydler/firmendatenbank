<?php /* Smarty version Smarty-3.0.7, created on 2011-05-03 22:03:28
         compiled from "./templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4563576414dc05f901c99f9-70329366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4563576414dc05f901c99f9-70329366',
  'function' => 
  array (
  ),
  'has_nocache_code' => true,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_capitalize')) include '/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include '/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include '/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include '/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/function.html_options.php';
?><?php echo '/*%%SmartyNocache:4563576414dc05f901c99f9-70329366%%*/<?php if (!is_callable(\'smarty_modifier_capitalize\')) include \'/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'/home/michael/Speicher/studium/webpp/project/Firmendatenbank/smarty/libs/plugins/modifier.date_format.php\';
?>/*/%%SmartyNocache:4563576414dc05f901c99f9-70329366%%*/';?>
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:4563576414dc05f901c99f9-70329366%%*/<?php echo $_smarty_tpl->getVariable(\'Name\')->value;?>
/*/%%SmartyNocache:4563576414dc05f901c99f9-70329366%%*/';?></b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:4563576414dc05f901c99f9-70329366%%*/<?php echo ((mb_detect_encoding($_smarty_tpl->getVariable(\'Name\')->value, \'UTF-8, ISO-8859-1\') === \'UTF-8\') ? mb_strtoupper($_smarty_tpl->getVariable(\'Name\')->value,SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable(\'Name\')->value));?>
/*/%%SmartyNocache:4563576414dc05f901c99f9-70329366%%*/';?></b>
